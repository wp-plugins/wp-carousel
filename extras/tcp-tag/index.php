<?php
	...
	$extra['name'] = __('Tagged Products', 'wp_carousel');
	...
	$extra['item_function'] = 'wpc_tcp_tag_item';	// Needed if it is a GROUP EXTRA
	...
	$suppliers = get_terms('tcp_product_tag', 'hide_empty=0');
