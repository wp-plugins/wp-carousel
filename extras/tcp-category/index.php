<?php
	...
	$extra['name'] = __('Category\'s Product', 'wp_carousel');
	$extra['url'] = "http://sumolari.com/wp-carousel";
	$extra['desc'] = __('Show products from a single category created with TheCartPress WordPress plugin', 'wp_carousel');
	$extra['version'] = '1.0';
	...
	$extra['item_function'] = 'wpc_tcp_category_item';	// Needed if it is a GROUP EXTRA
	...
	$suppliers = get_terms('tcp_product_category', 'hide_empty=0');
