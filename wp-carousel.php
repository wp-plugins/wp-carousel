<?php
	...
	*/
	...
	// ARREGLADO EL FALLO QUE MOSTRABA AVISO CUANDO NO HABIA CARRUSELES
	// ARREGLADO EL SISTEMA DE ORDENADO
	// NUEVO THEME: TWO COLS
	// ARREGLADA INCOMPATIBILIDAD CON SMOOTH SLIDER
	...
	*/
	...
	wp_register_script('wp_carousel_edit_carousel_init_js', $wp_carousel_path[6].'js/edit.carousel.init.js.js', array('jquery', 'jquery-ui-tabs')); // Código Javascript necesario para las páginas de opciones de cada carrusel
	...
	*/
	...
	//wp_register_style('wp_carousel_tablesorter_edit_carousel_table_css', $wp_carousel_path[6].'css/tablesorter.edit-carousel.table-css.css');
	...
	*/
	...
	/*
		...
		@Añadida en la versión: 0.4
		@Última actualización en la versión: 0.4.0.11
	*/
		...
		foreach ($items as $key => $value)
		{
			...
			{	
				...
				if ($items_adapted[$key]['POSTS_ORDER'] == 'first_new') // Primero van los nuevos artículos, así que... ¡A ordenar se ha dicho!
				{
					...
					{
						$items_adapted = $items_temp_adapted;
					}
				}
	...
	*/
	...
	function wp_carousel_adminmenu_links()
	{
		...
		add_object_page('WP Carousel', 'WP Carousel', 8, 'wp-carousel', 'wp_carousel_options_page', $wp_carousel_path[6].'img/wp_carousel.png');
		...
		switch ($type_exploded[0])
		{
			...
			case 'SELF_URL':
				...
				/*
					...
					A partir de la versión 0.4.0.10 se utiliza un nuevo método. Dejo esta línea por si es necesario regresar al método antiguo.
											...
											<div id="minor-publishing">  
												<div id="misc-publishing-actions"> 
													...
													<div class="misc-pub-section" id="posts_set_order">
														<span class="padding"><?php _e('Posts\' order', 'wp_carousel'); ?></span>
													...
													<div class="misc-pub-section" id="show_in_loop_div">
														<?php _e('Must I show this element in the loop?', 'wp_carousel'); ?>
