<?php
	...
	*/
	...
	/* 
		...
		- Nueva UI: Drag & Drop							*
		- Nuevo theme TwentyCarousels					#
		- Nuevos tipos de contenidos:						#
			- Tags													#
			- Autores												#
		- Mejorar el modo debug							#
		- Nueva API de contenidos							#
			- Plugin de demostración: Flikr					#
		- Dar uso a la pestaña de ayuda					*
	...
	*/
	...
	if (!defined('WP_CAROUSEL_SURVEY')) define('WP_CAROUSEL_SURVEY', 'http://survey.com');
	...
	*/
	...
	/*
		...
		@Versión: 1.0
		@Descripción: Añade un la función wp_carousel_custom_help_tab_filter al filtro de la pestaña de ayuda
	...
	*/
	...
	function wp_carousel_custom_help_tab_filter($help) {
		...
		echo '<p>';
		printf(__('You\'re using an Alpha Release of WP Carousel 0.5. Please, report errors <a href="%s">here (English)</a> or <a href="%s">here (Spanish)</a>.', 'wp_carousel'), 'http://foro.sumolari.com/index.php/board,34.0.html', 'http://foro.sumolari.com/index.php/board,15.0.html');
		echo '</p>';
	}
	...
	*/
	...
	{
		global $wp_carousel_path;
		echo '<script type="text/javascript" src="'.$wp_carousel_path[6].'js/init.stepcarousel.php?id='.$id.'"></script>';
	}
	...
	*/
	...
	function wp_carousel_adapt_items($items) {
		foreach ($items as $key => $value)
		{
			...
			if ($items_adapted[$key]['TYPE'] != 1 && $items_adapted[$key]['TYPE'] != 4)
			{
	...
	*/
	...
	function wp_carousel_adminmenu_links()
	{
		...
		add_object_page('WP Carousel', 'WP Carousel', 'administrator', 'wp-carousel', 'wp_carousel_options_page', $wp_carousel_path[6].'img/wp_carousel.png');
	...
	function wp_carousel_options_page($var='', $debug=false)
	{
		...
		*/
		...
		<div class="wrap">
			...
			<div class="error"><p><?php printf(__('You\'re using an Alpha Release of WP Carousel 0.5. Please, report errors <a href="%s">here (English)</a> or <a href="%s">here (Spanish)</a>.', 'wp_carousel'), 'http://foro.sumolari.com/index.php/board,34.0.html', 'http://foro.sumolari.com/index.php/board,15.0.html'); ?></p></div>
	...
	*/
	...
	function wp_carousel_carousel_options_page($var='', $debug=false)
	{
		...
		<div class="wrap">
			...
			<div class="updated fade"><p>New UI - DEV</p></div>
			...
			<div id="wp_carousel_ajax_response">
				<div class="updated changes_saved"><p><?php _e('Changes saved', 'wp_carousel'); ?></p></div>
			</div>
					...
					<div class="items_padder">	
						<div id="sortable_items" class="connected">
							...
							<div id="item_5" class="item">
								...
								<div class="item_content">
									<p><?php _e('Drag this item into the carousel to add posts from an <strong>specific tag</strong>', 'wp_carousel'); ?></p>
								</div>
							</div>
							...
							<div id="item_6" class="item">
								...
								<div class="item_content">
									<p><?php _e('Drag this item into the carousel to add posts from an <strong>specific author</strong>', 'wp_carousel'); ?></p>
								</div>
							</div>
		...
		foreach ($items as $internal_id => $item):
			...
			?>
							<div id="item_<?php echo $drag_drop_id; ?>" class="item">
								<div class="handle">
									<h4>
										<?php _e(wp_carousel_type_name($item['TYPE'], 'get'), 'wp_carousel'); ?>
									</h4>
								</div>
								<div class="item_content">
								...
								<form method="post" class="wp_carousel_ajax_form" onsubmit="return wp_carousel_update_ajax_item()">
									...
									<?php if ($item['TYPE'] == 1 || $item['TYPE'] == 2) { ?>
									<dl>
										<dt><?php _e('Must I show this element in the loop?', 'wp_carousel'); ?></dt>
	...
	function wp_carousel_type_name($id, $mode='get', $debug=false)
	{
		...
		switch ($id)
		{
			...
			case '4':
				...
				break;
			case '5':
				$log[] = 'La variable $id indica que se trata de una lista de categorias';
				$return = __('Category list', 'wp_carousel');
				break;
			case '6':
				$log[] = 'La variable $id indica que se trata de una etiqueta';
				$return = __('Tagt', 'wp_carousel');
				break;
			case '7':
				$log[] = 'La variable $id indica que se trata de una lista de etiquetas';
				$return = __('Tag list', 'wp_carousel');
				break;
			case '8':
				...
				break;
			case '9':
				$log[] = 'La variable $id indica que se trata de una lista de autores';
				$return = __('Author list', 'wp_carousel');
				break;
			default:
	...
	*/
	...
	/*
		...
		@Añadida en la versión: 0.4
		@Última actualización en la versión: 0.4.0.10
	*/
	...
	function wp_carousel_add_content_form()
	{
		...
		<div class="wp_carousel_tabs wp_carousel_tabs_js">
			...
			<div id="add_wordpress_content">
				<h2 class="js_hide"><?php _e('Add content from WordPress', 'wp_carousel'); ?></h2>
										...
										<div class="submitbox" id="submitpost"> 
											...
											<div id="minor-publishing">  
												<div id="misc-publishing-actions"> 
													...
													<div class="misc-pub-section">
														<span class="padding"><?php _e('Order', 'wp_carousel'); ?></span>
														<input type="text" name="order" id="order" class="right" value="0" />
														<div class="clear"></div>
													</div> 
													<div class="misc-pub-section" id="posts_set_order">
														<span class="padding"><?php _e('Posts\' order', 'wp_carousel'); ?> <span class="js_hide"><?php _e('(only for posts)', 'wp_carousel'); ?><br /> <br /></span></span>
														<select id="posts_order" class="right" name="posts_order">
															<option id="first_old" value="first_old"><?php _e('Show the oldest posts first', 'wp_carousel'); ?></option>
															<option id="first_new" value="first_new"><?php _e('Show the newest posts first', 'wp_carousel'); ?></option>
														</select>
														<div class="clear"></div>
													</div> 
													<div class="misc-pub-section" id="posts_set_number">
														<span class="padding"><?php _e('Number of posts', 'wp_carousel'); ?></span>
														<input type="text" name="posts_number" id="posts_number" class="right" value="10" />
														<div class="clear"></div>
													</div> 
													<div class="misc-pub-section" id="show_in_loop_div">
														<?php _e('Must I show this element in the loop?', 'wp_carousel'); ?> <span class="js_hide"><?php _e('(only for posts and categories)', 'wp_carousel'); ?></span>
								...
								<div id='normal-sortables' class='meta-box-sortables'> 
									...
									<div id="type" class="postbox"> 
										...
										<div class="inside"> 
											...
											<select id="type_list" class="type_list" name="type_list" onchange="wp_carousel_doShow()" onfocus="wp_carousel_doShow()">
									...
									<div id="content-list" class="postbox"> 
										...
										<div class="inside"> 
											...
											<div id="content_posts">
												<span class="js_hide"><?php _e('List of posts', 'wp_carousel'); ?><br /></span>
											...
											<div id="content_pages">
												<span class="js_hide"><?php _e('List of pages', 'wp_carousel'); ?><br /></span>
												<?php wp_carousel_dropdown_type_items('3'); ?>
											</div>
											
											<div id="content_categories">
												<span class="js_hide"><?php _e('List of categories', 'wp_carousel'); ?><br /></span>
			...
			<div id="add_costumized_content">
				<h2 class="js_hide"><?php _e('Add costumized content', 'wp_carousel'); ?></h2>
