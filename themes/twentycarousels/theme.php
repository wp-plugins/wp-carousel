	<div class="theme-twentycarousels">
	...
	<div id="carousel_<?php echo $c_id; ?>-paginate" class="wp_carousel_twentycarousels_pagination">
		<img src="<?php echo $wp_carousel_path[6]; ?>img/opencircle.png" data-over="<?php echo $wp_carousel_path[6]; ?>img/graycircle.png" data-select="<?php echo $wp_carousel_path[6]; ?>img/graycircle.png" data-moveby="1" />
	</div>
	<?php endif; ?>