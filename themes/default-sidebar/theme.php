	...
	<div class="theme-default-sidebar">
		<div class="bottom-div">
			...
			<div id="carousel_<?php echo $c_id; ?>-paginate" class="wp_carousel_default_sidebar_pagination">
				<img src="<?php echo $path[6]; ?>/img/opencircle.png" data-over="<?php echo $path[6]; ?>/img/graycircle.png" data-select="<?php echo $path[6]; ?>/img/closedcircle.png" data-moveby="1" />
			</div>
			<?php endif; ?>
		</div>
	</div>
