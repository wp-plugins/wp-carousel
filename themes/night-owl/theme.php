							...
							if (WP_CAROUSEL_SHOW_VIDEOS_FIRST)
								{
									if ($there_is_video)
									{
										echo apply_filters('the_content', '<div class="video_margin">[embed width="'.$temp_video_width.'"]'.$item['VIDEO'].'[/embed]</div>');
									}
									else
									{
										?>
										<div class="panel_image" style="background:url(<?php echo $item['IMAGE_URL']; ?>) 5px 0px; width:<?php echo $temp_video_width.'px'; ?>; height:<?php echo $temp_image_height; ?>;">
