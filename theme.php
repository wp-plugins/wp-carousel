						...
						if (WP_CAROUSEL_SHOW_VIDEOS_FIRST)
							{
								...
								{
									?>
									<div class="panel_image" style="background:url(<?php echo $item['IMAGE_URL']; ?>) 5px 0px <?php echo $repeat_mode; ?>; width:<?php echo $config['PANEL_WIDTH']; ?>; height:<?php echo $config['PANEL_HEIGHT']; ?>;">
